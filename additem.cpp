...
void AddItem::on_btnAdd_clicked()
{
    ...
    query.clear();
    query.prepare("insert into ventegestion(Name, Quantity, Status, DOP, DOS, SellingPrice, PurchasePrice) values ('" +sName +"','" +sQuantity + "','"+ sStatus + "','" +sDOP + "','"+ sDOS+ "','"+sSellingPrice+ "','"+ sPurchasePrice + "')");
